// TODO: Fix any type
// TODO: Replace actual network type
...
declare class Address {
   ...
   *
   */
  toEcashAddress(address: string, prefix?: boolean): string;
  /**
   ...
   */
  ecashtoCashAddress(address: string, prefix?: boolean): string;
  /**
   ...
   */
  hash160ToLegacy(hash160: string, network?: number): string; // TODO: Actual network type
  /**
   ...
   */
  hash160ToCash(hash160: string, network?: number, regtest?: boolean): string; // TODO: Actual network type
  _decode(address: string): any;
  _decodeLegacyAddress(address: string): {
    prefix: string;
    type: string;
    hash: any;
    format: string;
  ...
  _decodeEcashAddress(address: string): any;
  /**
   ...
   *  // legacy
   */
  detectAddressFormat(address: string): any;
  /**
   ...
   *  // testnet
   */
  detectAddressNetwork(address: string): "testnet" | "mainnet" | "regtest";
  /**
   ...
   *  // p2pkh
   */
  detectAddressType(address: string): any;
  /**
